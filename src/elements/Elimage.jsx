...
const ProfileOutter = styled.div`
  ...
  ${(props) =>
    props.minWidth ? `min-width: ${props.minWidth}` : "min-width:190px"};
  ${(props) => (props.height ? `height: ${props.height}` : "height:100%")};
  ${(props) =>
    props.minHeight ? `min-height: ${props.minHeight}` : "min-height:190px"};
`;
const ProfileInner = styled.div`
  ...
  ${(props) =>
    props.br ? `border-radius: ${props.br}` : "border-radius:24px"};
`;

const BookImgOutter = styled.div`
  ${(props) => (props.width ? `width: ${props.width}` : "width:100%")};
  ${(props) =>
    props.minWidth ? `min-width: ${props.minWidth}` : "min-width:150px"};
  ${(props) => (props.height ? `height: ${props.height}` : "height:100%")};
  ${(props) =>
    props.minHeight ? `min-height: ${props.minHeight}` : "min-height:220px"};
`;
...
const CardImgOutter = styled.div`
  ${(props) => (props.width ? `width: ${props.width}` : "width:100%")};
  ${(props) =>
    props.minWidth ? `min-width: ${props.minWidth}` : "min-width:193px"};
  ${(props) => (props.height ? `height: ${props.height}` : "height:100%")};
  ${(props) =>
    props.minHeight ? `min-height: ${props.minHeight}` : "min-height:193px"};
`;
